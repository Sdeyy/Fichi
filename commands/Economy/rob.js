    ...
    run: async (client, interaction, args) => {
        ...
        if (targetData.money < 100)
            return interaction.reply({
                content: `${client.language.Economy.RobberyTargetNotEnoughMoney}`
            });
        ...
        if (success) {
            ...
            interaction.reply({
                content: `${client.language.Economy.RobberySuccess}`
                    .replaceAll("<targetTag>", target.tag)
            ...
            interaction.reply({
                content: `${client.language.Economy.RobberyFailed}`
                    .replaceAll("<targetTag>", target.tag)
                    .replaceAll("<fine>", fine)
            });
        }
    }
}
